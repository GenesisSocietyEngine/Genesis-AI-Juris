...
export const OPERATIONAL_ALERT_RUNBOOK: Record<ObservabilityAlert["id"], OperationalAlertRunbookEntry> = {
  worker_exception: {
    ...
    rollbackCriterion: "Roll back to verified Site version 63 when the exception is attributable to v62 or the route cannot be stabilized promptly.",
  ...
  worker_5xx: {
    ...
    rollbackCriterion: "Roll back to verified Site version 63 when v62 causes sustained or unexplained 5xx responses.",
    source: "platform_logs",
    evaluation: "manual_platform_configuration_required",
    externalNotification: "unavailable",
  },
  d1_failures: {
    ...
    rollbackCriterion: "Roll back to verified Site version 63 if v62 query behavior is responsible; otherwise follow the D1 incident path.",
    source: "platform_logs",
    evaluation: "manual_platform_configuration_required",
    externalNotification: "unavailable",
  },
  d1_latency_p95: {
    ...
    threshold: "Policy fixture: p95 greater than 500 ms over 15 minutes; routine success latency is not collected in v62",
    owner: "Platform on-call",
    ...
    rollbackCriterion: "Roll back to verified Site version 63 when the latency regression is isolated to v62.",
  ...
  replay_internal_failure: {
    ...
    threshold: "3 failures from exact retained rows in 15 minutes; the 2% of 20+ attempts rate leg is not collected in v62",
    ...
    rollbackCriterion: "Roll back to verified Site version 63 for a v62 replay regression or any canonical-state uncertainty.",
    source: "split",
  ...
  historical_lookup_miss: {
    ...
    rollbackCriterion: "Stop the release and roll back to verified Site version 63 if a v62 manifest or catalog reference is missing.",
    source: "split",
  ...
  expected_identity_rejections: {
    ...
    rollbackCriterion: "No automatic rollback; escalate if the rejections indicate an incorrect v62 release identity.",
    source: "split",
    evaluation: "active_in_admin_dashboard",
    externalNotification: "unavailable",
  },
