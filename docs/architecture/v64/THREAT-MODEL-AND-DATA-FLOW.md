...
| Forged/stale role, membership, dossier participation, or delegated grant | bind current membership/version/roles/dossier to server context; resolve delegated and export grants plus approval sets from immutable server records |
