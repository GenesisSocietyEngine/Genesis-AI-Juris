...
| Self-approve a legal hold by spoofing the requester | resolve requester/action from the immutable request by `request_id`; bind approver to the authenticated session; require distinct actors and receipts |
