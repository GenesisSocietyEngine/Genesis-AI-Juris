      ...
      {documents.map((document) => {
        ...
        return <article className={styles.documentCard} key={document.id}>
          ...
          {current && <div className={styles.currentVersion}>
            ...
            {current.downloadUrl ? <a className={styles.secondaryButton} href={current.downloadUrl} aria-label={"Securely download current version of " + document.title}>Secure download</a> : <span className={styles.unavailableAction}>Secure download is not exposed by this pilot API.</span>}
          </div>}
