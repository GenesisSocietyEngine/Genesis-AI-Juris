...
import type { TaxEconomicsResult } from "./tax-economics";
import type { DealEconomicsV1, TaxEconomicsV1 } from "./types";

type Locale = "en" | "ru";

export default function StudioOutcomeParameters({locale,dealModel,taxModel,taxResult,disabled,beginFieldEdit,commitDealField,setDealModel,changeRepaymentBasis,applyTaxChange}:{locale:Locale;dealModel:DealEconomicsV1|null|undefined;taxModel:TaxEconomicsV1;taxResult:TaxEconomicsResult|null;disabled:boolean;beginFieldEdit:(value:string)=>void;commitDealField:(label:string,value:string)=>void;setDealModel:(change:Partial<DealEconomicsV1>)=>void;changeRepaymentBasis:(basis:DealEconomicsV1["repaymentBasis"])=>void;applyTaxChange:(change:Partial<TaxEconomicsV1>,label:string)=>void}) {
